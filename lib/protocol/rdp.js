...
function RdpClient(config) {
	...
	// this.clipSec = new pdu.clipSec.Client(this.mcs, this.tpkt);
	this.cliprdr = new pdu.cliprdr.Client(this.mcs, this.tpkt);
	this.global = new pdu.global.Client(this.sec, this.sec);
	
	// this.cliprdr = new pdu.cliprdr.Client(this.clipSec, this.clipSec);
