...
var cliprdr = require('../channels/cliprdr');
...
MCS.prototype.recv = function(s) {
	...
	console.log('[MCS] recv: opcode', opcode);
...
function Client(transport) {
	...
	// cliprdr channel
	this.clientNetworkData = gcc.clientNetworkData(new type.Component([cliprdr.CliprdrChannelDef]));
